    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField(verbose_name='Page Body')),
                ('success', models.CharField(max_length=255, verbose_name='Success Message')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='form_fields', to='cms.FormPage'),
